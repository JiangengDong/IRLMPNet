...
#ifndef IRLMPNET_SYSTEM_CAR_SYSTEMPYTHON_H
#define IRLMPNET_SYSTEM_CAR_SYSTEMPYTHON_H
...
namespace IRLMPNet {
    namespace System {
        class Car1OrderSystemPython : Car1OrderSystem {
        public:
            Car1OrderSystemPython(const unsigned int obstacle_index = 0) : Car1OrderSystem(obstacle_index) {
            }
